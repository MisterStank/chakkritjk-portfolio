...
export default function intro() {
  return (
    <section className='mb-28 max-q-[50rem] text-center'>
        ...
        <motion.p className='mb-10 mt-4 px-4 text-2xl font-medium flex flex-col 
        !leading-[1.5] sm:text-4xl'
          initial={{opacity:0,y:100}}
          animate={{opacity:1,y:0}}
        >
          <span className='font-semibold'>Hello, I'm Chakkrit Jongkraijak</span>
          <span>A computer engineering student</span>
          <span>at Chulalongkorn University</span>
        </motion.p>
        ...
        >
          ...
          <a className='group bg-white text-gray-900 px-7 py-3 flex 
            items-center gap-2 rounded-full outline-none
            focus:scale-110 hover:scale-110
            active:scale-105
          ...
          <a className='bg-white text-gray-700 p-4 flex 
            ...
            transition cursor-pointer border border-black/10'
            href='https://www.linkedin.com/in/chakkrit-jongkraijak-537b97296/'
            target='_blank'
            >
            <BsLinkedin/>
          </a>
          <a className='bg-white text-gray-700 p-4 flex 
            items-center gap-2 rounded-full text-[1.35rem] outline-none
