...
export default function Project({
    ...
    const opacityProgress = useTransform(scrollYProgress, [0, 1], [0.6, 0.8])
    return <motion.div 
    ref={ref} 
    style={{
        scale: scaleProgress,
        ...
        border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative
        ...
        className='absolute top-8 -right-40 w-[28.25rem] rounded-lg
